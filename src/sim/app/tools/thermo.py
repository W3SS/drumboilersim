...
"""Package contem as funcoes de aproximacao das propriedades termodi-
namicas da agua
...
def T_sat(P):
    """Temperatuda de saturação da água
    Recebe: P(MPa)
    Retorna: Celsius"""
    if P < .07 or P > 21.85:
        raise ValueError("Valor fora do range")
...
######################################################################
# Derivadas das funções anteriores (em função da Pressão)
######################################################################

def dD_l_dP(P):
    """Derivada em relação à pressão da densidade do liquido
    Recebe: P (MPa)"""
...
def dD_g_dP(P):
    """Derivada em relação à pressão da densidade do gas
    Recebe: P(MPa)"""
    if P <= .085 or P > 21.5:
        raise ValueError("Valor fora do range")
    elif P < 1.112:
...
def dh_l_dP(P):
    """Derivada em relação à pressão da entalpia da agua
    Recebe: P(MPa)"""
    if P <= .075 or P > 21.7:
        raise ValueError("Valor fora do range")
    elif P < .942:
...
def dh_g_dP(P):
    """Derivada em relação à pressão da entalpia do gas
    Recebe: P(MPa)"""
    if P <= .075 or P > 21.55:
        raise ValueError("Valor fora do range")
    elif P <= .348:
...
def dT_sat_dP(P):
    """Derivada em relação à pressão da temperatuda de saturação da
        água
    Recebe: P(MPa)"""
    if P < .07 or P > 21.85:
        raise ValueError("Valor fora do range")
