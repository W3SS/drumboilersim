class Interface:
    ...
    dos meios, a funcao e chamada.

    CONSTRUCTOR ARGS:
      > rep_evt: Funcao de resposta a requisicoes. Ela deve receber
        uma string e retornar outra string
      > pull_evt: Funcao de resposta a comandos de acao. Deve receber
        uma string."""
    ...
    def act(self):
        """Ve se tem mensagens na fila e, caso haja, realiza a acao
        necessaria"""
